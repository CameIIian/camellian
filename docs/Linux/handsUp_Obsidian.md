---
title: Obsidianで電子の世界に記録を残そう
description: Obsidian+Dropbox環境を各Platformにインストールした際のメモ。
date: 2025-10-29
tags:
- Markdown
- Editor
...
```
アイコンはこちらから  
[https://obsidian.md/blog/new-obsidian-icon/](https://obsidian.md/blog/new-obsidian-icon/)  
参考  
[https://qiita.com/akiralab/items/35ab02b1fa6db2e6c94f](https://qiita.com/akiralab/items/35ab02b1fa6db2e6c94f)
### Androidでの設定
...
参考  
[https://note.com/penchi/n/nc1b42ccdf368](https://note.com/penchi/n/nc1b42ccdf368)
## 3. その他便利なプラグイン
### Outline
...
参考  
[https://qiita.com/Kei_Adachi/items/1f5d01230334574f2e26#commander](https://qiita.com/Kei_Adachi/items/1f5d01230334574f2e26#commander)
## 4. 外観の変更
オプション > 外観 > テーマ > 管理 からテーマをダウンロード可  
`dracula`と`catppuccin`系統が好みなので気分で使い分けている  
