...
const config: SiteConfig = {
  ...
  site: 'https://camellian.pages.dev/',
  ...
  socialLinks: {
    twitter: 'https://x.com/Camellian_vrc',
    github: 'https://github.com/CameIIian',
  ...
  giscus: {
    repo: 'CameIIian/camellian',
    repoId: 'R_kgDORL6Hdg',
    category: 'Announcements',
    categoryId: 'DIC_kwDORL6Hds4C5_5T',
